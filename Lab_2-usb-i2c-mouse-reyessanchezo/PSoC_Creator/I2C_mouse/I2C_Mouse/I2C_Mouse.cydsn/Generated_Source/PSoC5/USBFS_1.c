...
{
    uint8 cr1Reg = USBFS_1_CR1_REG;

    /* Clear bus activity. */
    USBFS_1_CR1_REG = (cr1Reg & (uint8) ~USBFS_1_CR1_BUS_ACTIVITY);
                                                                        ...
                                                                        
{
    if ((epNumber > USBFS_1_EP0) && (epNumber < USBFS_1_MAX_EP))
    {
        ...
        USBFS_1_SIE_EP_BASE.sieEp[epNumber].epCnt0 = (uint8) HI8(length) | USBFS_1_EP[epNumber].epToggle;
        USBFS_1_SIE_EP_BASE.sieEp[epNumber].epCnt1 = (uint8) LO8(length);
        ...
        USBFS_1_SIE_EP_BASE.sieEp[epNumber].epCr0 = USBFS_1_EP[epNumber].epMode;
            ...
            if ((pData != NULL) && (length > 0u))
            {
                ...
                USBFS_1_ARB_EP_BASE.arbEp[epNumber].epCfg |=  (uint8)  USBFS_1_ARB_EPX_CFG_DMA_REQ;
                USBFS_1_ARB_EP_BASE.arbEp[epNumber].epCfg &=  (uint8) ~USBFS_1_ARB_EPX_CFG_DMA_REQ;
