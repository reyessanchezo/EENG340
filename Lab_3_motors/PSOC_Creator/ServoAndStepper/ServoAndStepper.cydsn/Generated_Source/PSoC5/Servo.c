...
{
    uint8 staticBits = (Servo_DR & (uint8)(~Servo_MASK));
    Servo_DR = staticBits | ((uint8)(value << Servo_SHIFT) & Servo_MASK);
}
...
{
	CyPins_SetPinDriveMode(Servo_0, mode);
}
...
{
    return (Servo_PS & Servo_MASK) >> Servo_SHIFT;
}
...
{
    return (Servo_DR & Servo_MASK) >> Servo_SHIFT;
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Servo_0_INTR) != 0u) 
		{ 
			 Servo_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Servo_INTSTAT & Servo_MASK) >> Servo_SHIFT;
    }
