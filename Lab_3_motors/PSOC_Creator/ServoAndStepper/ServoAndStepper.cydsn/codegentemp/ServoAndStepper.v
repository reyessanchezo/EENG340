// ======================================================================
// ServoAndStepper.v generated from TopDesign.cysch
// 03/07/2024 at 14:37
...
module ADC_SAR_v3_10_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("4168775f-bbda-4ea6-8cc7-694b2a315f71/dea208d9-07b0-438b-a5e0-ac5d207f2658/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module ADC_SAR_SEQ_v2_10_2 (
	...
	cy_clock_v1_0
		#(.id("4168775f-bbda-4ea6-8cc7-694b2a315f71/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("535723660.878351"),
		  .is_direct(0),
		  .is_digital(1))
		IntClock
		 (.clock_out(Net_3874));
	...
	cy_clock_v1_0
		#(.id("4168775f-bbda-4ea6-8cc7-694b2a315f71/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("f3eb7be3-8d0c-4ee2-87fe-178d25d3e9d2"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("20000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__JoyX_net;
	wire [0:0] tmpFB_0__JoyX_net;
	wire [0:0] tmpIO_0__JoyX_net;
	wire [0:0] tmpINTERRUPT_0__JoyX_net;
	electrical [0:0] tmpSIOVREF__JoyX_net;
	...
	cy_psoc3_pins_v1_10
		...
		JoyX
		 (.oe(tmpOE__JoyX_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__JoyX_net[0:0]}),
		  .analog({Net_37}),
		  .io({tmpIO_0__JoyX_net[0:0]}),
		  .siovref(tmpSIOVREF__JoyX_net),
		  .interrupt({tmpINTERRUPT_0__JoyX_net[0:0]}),
		  .annotation({Net_374}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__JoyX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__JoyY_net;
	wire [0:0] tmpFB_0__JoyY_net;
	wire [0:0] tmpIO_0__JoyY_net;
	wire [0:0] tmpINTERRUPT_0__JoyY_net;
	electrical [0:0] tmpSIOVREF__JoyY_net;

	cy_psoc3_pins_v1_10
		#(.id("7bf09d37-5be6-4611-a0b7-6fc57bd99a9a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		JoyY
		 (.oe(tmpOE__JoyY_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__JoyY_net[0:0]}),
		  .analog({Net_39}),
		  .io({tmpIO_0__JoyY_net[0:0]}),
		  .siovref(tmpSIOVREF__JoyY_net),
		  .interrupt({tmpINTERRUPT_0__JoyY_net[0:0]}),
		  .annotation({Net_375}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__JoyY_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("546bff58-2c37-47a4-92ed-1cc4335fd425"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("90a6f784-09d8-46a8-93b9-e2a27460c413"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Stepper_Step_net;
	wire [0:0] tmpFB_0__Stepper_Step_net;
	wire [0:0] tmpIO_0__Stepper_Step_net;
	wire [0:0] tmpINTERRUPT_0__Stepper_Step_net;
	electrical [0:0] tmpSIOVREF__Stepper_Step_net;

	cy_psoc3_pins_v1_10
		#(.id("063786fb-5222-4acc-9bd3-5beca1ba0c13"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Stepper_Step
		 (.oe(tmpOE__Stepper_Step_net),
		  .y({Net_616}),
		  .fb({tmpFB_0__Stepper_Step_net[0:0]}),
		  .io({tmpIO_0__Stepper_Step_net[0:0]}),
		  .siovref(tmpSIOVREF__Stepper_Step_net),
		  .interrupt({tmpINTERRUPT_0__Stepper_Step_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Stepper_Step_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Stepper_Direction_net;
	wire [0:0] tmpFB_0__Stepper_Direction_net;
	wire [0:0] tmpIO_0__Stepper_Direction_net;
	wire [0:0] tmpINTERRUPT_0__Stepper_Direction_net;
	electrical [0:0] tmpSIOVREF__Stepper_Direction_net;

	cy_psoc3_pins_v1_10
		#(.id("107ab92b-c47f-4082-af5a-e4e5b08017c1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Stepper_Direction
		 (.oe(tmpOE__Stepper_Direction_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Stepper_Direction_net[0:0]}),
		  .io({tmpIO_0__Stepper_Direction_net[0:0]}),
		  .siovref(tmpSIOVREF__Stepper_Direction_net),
		  .interrupt({tmpINTERRUPT_0__Stepper_Direction_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Stepper_Direction_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_4 PWM_Stepper (
        .capture(1'b0),
        .clock(Net_640),
        .cmp_sel(1'b0),
        .enable(1'b1),
        ...
        .tc(Net_619),
        .trigger(1'b0));
    defparam PWM_Stepper.Resolution = 16;
