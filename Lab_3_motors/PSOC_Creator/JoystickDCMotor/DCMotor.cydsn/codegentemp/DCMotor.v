// ======================================================================
// DCMotor.v generated from TopDesign.cysch
// 03/21/2024 at 12:59
...
module top ;
    ...
    cy_annotation_universal_v1_0 Joy_Y (
        .connect({
            Net_674,
            Net_673,
            Net_375
    ...
    defparam Joy_Y.comp_name = "Potentiometer_v1_0";
    defparam Joy_Y.port_names = "T1, T2, W";
    defparam Joy_Y.width = 3;

    cy_annotation_universal_v1_0 Joy_X (
        .connect({
            Net_674,
            Net_673,
            Net_374
    ...
    defparam Joy_X.comp_name = "Potentiometer_v1_0";
    defparam Joy_X.port_names = "T1, T2, W";
    defparam Joy_X.width = 3;
	...
	wire [0:0] tmpOE__ATop_net;
	wire [0:0] tmpFB_0__ATop_net;
	wire [0:0] tmpIO_0__ATop_net;
	wire [0:0] tmpINTERRUPT_0__ATop_net;
	electrical [0:0] tmpSIOVREF__ATop_net;

	cy_psoc3_pins_v1_10
		#(.id("b8c0de1e-7265-4f15-a38e-cb5bb3809bdc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ATop
		 (.oe(tmpOE__ATop_net),
		  .y({Net_682}),
		  .fb({tmpFB_0__ATop_net[0:0]}),
		  .io({tmpIO_0__ATop_net[0:0]}),
		  .siovref(tmpSIOVREF__ATop_net),
		  .interrupt({tmpINTERRUPT_0__ATop_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ATop_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ABot_net;
	wire [0:0] tmpFB_0__ABot_net;
	wire [0:0] tmpIO_0__ABot_net;
	wire [0:0] tmpINTERRUPT_0__ABot_net;
	electrical [0:0] tmpSIOVREF__ABot_net;

	cy_psoc3_pins_v1_10
		#(.id("0c8afb9a-58da-497b-ac60-76edac5b59b8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ABot
		 (.oe(tmpOE__ABot_net),
		  .y({Net_681}),
		  .fb({tmpFB_0__ABot_net[0:0]}),
		  .io({tmpIO_0__ABot_net[0:0]}),
		  .siovref(tmpSIOVREF__ABot_net),
		  .interrupt({tmpINTERRUPT_0__ABot_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ABot_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_3 PWM_DC (
        ...
        .tc(Net_661),
        .trigger(1'b0));
    defparam PWM_DC.Resolution = 16;


	cy_clock_v1_0
		#(.id("41a5adce-d620-4449-a843-e68c4883cae1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__PWM_Out_DC_net;
	wire [0:0] tmpFB_0__PWM_Out_DC_net;
	wire [0:0] tmpIO_0__PWM_Out_DC_net;
	wire [0:0] tmpINTERRUPT_0__PWM_Out_DC_net;
	electrical [0:0] tmpSIOVREF__PWM_Out_DC_net;

	cy_psoc3_pins_v1_10
		#(.id("dc6f04ed-a213-4d69-a2c8-36f315ee7e37"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_Out_DC
		 (.oe(tmpOE__PWM_Out_DC_net),
		  .y({Net_509}),
		  .fb({tmpFB_0__PWM_Out_DC_net[0:0]}),
		  .io({tmpIO_0__PWM_Out_DC_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_Out_DC_net),
		  .interrupt({tmpINTERRUPT_0__PWM_Out_DC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_Out_DC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    begin : demux_1
        ...
        always @(Net_509 or Net_701)
        begin
            case (Net_701)
                1'b0:
                begin
                    tmp__demux_1_0_reg = Net_509;
                    tmp__demux_1_1_reg = 1'b0;
                end
                1'b1:
                begin
                    tmp__demux_1_0_reg = 1'b0;
                    tmp__demux_1_1_reg = Net_509;
                end
            endcase
        end
        assign Net_682 = tmp__demux_1_0_reg;
        assign Net_681 = tmp__demux_1_1_reg;
    end
    // -- De Mux end --

    cy_annotation_universal_v1_0 Motor (
        .connect({
            Net_679,
            Net_680
        })
    );
    defparam Motor.comp_name = "Inductor_v1_0";
    defparam Motor.port_names = "T1, T2";
    defparam Motor.width = 2;

	wire [0:0] tmpOE__BTop_net;
	wire [0:0] tmpFB_0__BTop_net;
	wire [0:0] tmpIO_0__BTop_net;
	wire [0:0] tmpINTERRUPT_0__BTop_net;
	electrical [0:0] tmpSIOVREF__BTop_net;

	cy_psoc3_pins_v1_10
		#(.id("cba633da-96bc-4ac1-9ff7-4a99be0b48c1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		BTop
		 (.oe(tmpOE__BTop_net),
		  .y({Net_693}),
		  .fb({tmpFB_0__BTop_net[0:0]}),
		  .io({tmpIO_0__BTop_net[0:0]}),
		  .siovref(tmpSIOVREF__BTop_net),
		  .interrupt({tmpINTERRUPT_0__BTop_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BTop_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BBot_net;
	wire [0:0] tmpFB_0__BBot_net;
	wire [0:0] tmpIO_0__BBot_net;
	wire [0:0] tmpINTERRUPT_0__BBot_net;
	electrical [0:0] tmpSIOVREF__BBot_net;

	cy_psoc3_pins_v1_10
		#(.id("6836adc4-07b3-4428-9a3f-75b8ef06e425"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		BBot
		 (.oe(tmpOE__BBot_net),
		  .y({Net_684}),
		  .fb({tmpFB_0__BBot_net[0:0]}),
		  .io({tmpIO_0__BBot_net[0:0]}),
		  .siovref(tmpSIOVREF__BBot_net),
		  .interrupt({tmpINTERRUPT_0__BBot_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BBot_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    begin : demux_2
        ...
        always @(Net_509 or Net_698)
        begin
            case (Net_698)
                1'b0:
                begin
                    tmp__demux_2_0_reg = Net_509;
                    tmp__demux_2_1_reg = 1'b0;
                end
                1'b1:
                begin
                    tmp__demux_2_0_reg = 1'b0;
                    tmp__demux_2_1_reg = Net_509;
                end
            endcase
        end
        assign Net_693 = tmp__demux_2_0_reg;
        assign Net_684 = tmp__demux_2_1_reg;
    end
    // -- De Mux end --

    CyControlReg_v1_80 DriverControlReg (
        .clock(1'b0),
        .control_0(Net_701),
        .control_1(Net_698),
        .control_2(Net_699),
        ...
        .control_7(Net_705),
        .reset(1'b0));
    defparam DriverControlReg.Bit0Mode = 0;
    defparam DriverControlReg.Bit1Mode = 0;
    defparam DriverControlReg.Bit2Mode = 0;
    defparam DriverControlReg.Bit3Mode = 0;
    defparam DriverControlReg.Bit4Mode = 0;
    defparam DriverControlReg.Bit5Mode = 0;
    defparam DriverControlReg.Bit6Mode = 0;
    defparam DriverControlReg.Bit7Mode = 0;
    defparam DriverControlReg.BitValue = 3;
    defparam DriverControlReg.BusDisplay = 0;
    defparam DriverControlReg.ExtrReset = 0;
    defparam DriverControlReg.NumOutputs = 2;
