// ======================================================================
// Lab01.v generated from TopDesign.cysch
// 02/01/2024 at 10:17
...
module SCB_UART_PDL_v2_0_0 (
	...
	cy_clock_v1_0
		#(.id("94436e49-2cfa-438f-9459-74c3a35f3d1f/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("94436e49-2cfa-438f-9459-74c3a35f3d1f/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("94436e49-2cfa-438f-9459-74c3a35f3d1f/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module Scan_ADC_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("fcf7f866-2a03-499c-aba1-b59f4cc65ec9/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
module VDAC12_PDL_v2_0_3 (
	...
	cy_connect_v1_0 cy_analog_virtualmux_1_connect(vout, ct_vout_buf);
	defparam cy_analog_virtualmux_1_connect.sig_width = 1;

    cy_mxs40_opamp_v1_0 VOUTBUF (
        .ctb_dsi_comp(Net_36),
        .out_10x(Net_14),
        .out_1x(Net_16),
        .vminus(ct_vout_buf),
        .vplus(ct_vout));
    defparam VOUTBUF.deepsleep_available = 0;
    defparam VOUTBUF.has_resistor = 0;
    defparam VOUTBUF.needs_dsab = 0;

	// cy_analog_virtualmux_3 (cy_analog_virtualmux_v1_0)
	cy_connect_v1_0 cy_analog_virtualmux_3_connect(ct_vout_buf, Net_14);
...
// IDAC7_P6_v1_0(IDACRange=13, Polarity=0, Value=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC7_P6_v1_0, CY_CONFIG_TITLE=IDAC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC, CY_INSTANCE_SHORT_NAME=IDAC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=IDAC, )
module IDAC7_P6_v1_0_4 (
    Iout);
    inout       Iout;
    electrical  Iout;
    ...
    cy_mxs40_csidac_v1_0 cy_mxs40_csidac (
        .dsi_idac_leg1_en(Net_106),
        .dsi_idac_leg2_en(Net_107),
        .dsi_idac_leg3_en(Net_108),
        .dsi_idac_pol(Net_109),
        .iout(Iout));
    defparam cy_mxs40_csidac.leg3_needed = 0;
...
module top ;
    ...
    IDAC7_P6_v1_0_4 IDAC (
        .Iout(Net_202));

	wire [0:0] tmpFB_0__VDAC_VC_net;
	wire [0:0] tmpIO_0__VDAC_VC_net;
	electrical [0:0] tmpSIOVREF__VDAC_VC_net;
	...
	cy_mxs40_gpio_v1_0
		...
		VDAC_VC
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__VDAC_VC_net[0:0]}),
		  .analog({Net_74}),
		  .io({tmpIO_0__VDAC_VC_net[0:0]}),
		  .siovref(tmpSIOVREF__VDAC_VC_net),
		  .annotation({Net_79}));


	wire [0:0] tmpFB_0__IDAC_IB_net;
	wire [0:0] tmpIO_0__IDAC_IB_net;
	electrical [0:0] tmpSIOVREF__IDAC_IB_net;

	cy_mxs40_gpio_v1_0
		#(.id("ec64f24f-8d37-4c51-917b-d7d3f552c801"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		IDAC_IB
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__IDAC_IB_net[0:0]}),
		  .analog({Net_202}),
		  .io({tmpIO_0__IDAC_IB_net[0:0]}),
		  .siovref(tmpSIOVREF__IDAC_IB_net),
		  .annotation({Net_130}));


	wire [0:0] tmpFB_0__VCH_net;
	wire [0:0] tmpIO_0__VCH_net;
	electrical [0:0] tmpSIOVREF__VCH_net;

	cy_mxs40_gpio_v1_0
		#(.id("3047c89b-cd8e-4020-be02-c2473f949b23"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		VCH
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__VCH_net[0:0]}),
		  .analog({Net_37}),
		  .io({tmpIO_0__VCH_net[0:0]}),
		  .siovref(tmpSIOVREF__VCH_net));


	wire [0:0] tmpFB_0__VCL_net;
	wire [0:0] tmpIO_0__VCL_net;
	electrical [0:0] tmpSIOVREF__VCL_net;

	cy_mxs40_gpio_v1_0
		#(.id("4e7089af-d272-4783-99dd-6052ff4f31f8"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		VCL
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__VCL_net[0:0]}),
		  .analog({Net_38}),
		  .io({tmpIO_0__VCL_net[0:0]}),
		  .siovref(tmpSIOVREF__VCL_net));


	wire [0:0] tmpFB_0__VBH_net;
	wire [0:0] tmpIO_0__VBH_net;
	electrical [0:0] tmpSIOVREF__VBH_net;

	cy_mxs40_gpio_v1_0
		#(.id("e563f5ed-7274-4121-994e-117aa3275705"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		VBH
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__VBH_net[0:0]}),
		  .analog({Net_167}),
		  .io({tmpIO_0__VBH_net[0:0]}),
		  .siovref(tmpSIOVREF__VBH_net));


	wire [0:0] tmpFB_0__VBL_net;
	wire [0:0] tmpIO_0__VBL_net;
	electrical [0:0] tmpSIOVREF__VBL_net;

	cy_mxs40_gpio_v1_0
		#(.id("a94f25b8-ba68-4978-b714-7e85a508197c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		VBL
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__VBL_net[0:0]}),
		  .analog({Net_168}),
		  .io({tmpIO_0__VBL_net[0:0]}),
		  .siovref(tmpSIOVREF__VBL_net));



	cy_clock_v1_0
		#(.id("c21d7ec5-2825-4931-9d92-5a241a170587"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
		  .period("4000000000"),
		  .is_direct(0),
