...
static void ClockInit(void)
{
	...
	Cy_SysClk_PeriphAssignDivider(PCLK_PASS_CLOCK_CTDAC, CY_SYSCLK_DIV_8_BIT, 2u);
	Cy_SysClk_PeriphSetDivider(CY_SYSCLK_DIV_8_BIT, 2u, 199u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_REG32(CYREG_CTBM0_CTD_SW, 0x00002200u);
	CY_SET_REG32(CYREG_SAR_CTRL, 0x80000000u);
	CY_SET_REG32(CYREG_SAR_MUX_SWITCH0, 0x0000000Fu);
	CY_SET_REG32(CYREG_SAR_MUX_SWITCH_SQ_CTRL, 0x0000000Fu);
